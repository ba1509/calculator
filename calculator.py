# -*- coding: utf-8 -*-
"""
Created on Sun Jul  9 22:32:05 2023
...
def evaluate_calculation(): #evalv function
   global calculation
   try:
...
btn_add = tk.Button(root, text = "+", command = lambda: add_to_calculation("+"),width = 5, font = ("Arial",24))
btn_add.grid(row = 2, column = 4)
btn_subs = tk.Button(root, text = "-", command = lambda: add_to_calculation("-"),width = 5, font = ("Arial",24))
...
btn_brack_left = tk.Button(root, text = "(", command = lambda: add_to_calculation("("),width = 5, font = ("Arial",24))
btn_brack_left.grid(row = 5, column = 1)
btn_brack_right = tk.Button(root, text = ")", command = lambda: add_to_calculation(")"),width = 5, font = ("Arial",24))
btn_brack_right.grid(row = 5, column = 3)
btn_clear = tk.Button(root, text = "C", command = clear_field ,width = 5, font = ("Arial",24))
btn_clear.grid(row = 6, column = 1, columnspan = 2)
btn_equal = tk.Button(root, text = "=", command = evaluate_calculation ,width = 5, font = ("Arial",24))
